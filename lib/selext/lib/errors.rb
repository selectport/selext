...
# standard app errors
    ...
    class AccessDenied              < StandardError  ; end  # 521
    class AuthorizationNotPerformed < StandardError  ; end  # 522
    class ControlledBurn            < StandardError  ; end  # 523
    class FileNotFound              < StandardError  ; end  # 524
    class FrozenAccess              < StandardError  ; end  # 525
    class LoginRequired             < StandardError  ; end  # 526
    class ProcessingError           < StandardError  ; end  # 527
    class ProgrammingError          < StandardError  ; end  # 528
...
# ------------------------------------------------------------------------------
    ...
    class HTTPStatusError < Error
      ...
      def initialize(message = nil, id = nil, status = nil)
        meta    = Selext::Errors::META[self.class]
    ...
    # valid/success/informational 200's
